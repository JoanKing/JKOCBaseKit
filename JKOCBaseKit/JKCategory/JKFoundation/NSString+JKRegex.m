...
+(NSString *)jk_bankNameAccordingToBankNumber:(NSString *)bankNumber{
    ...
    // 加载资源文件的路径
    // Frameworks/IMBaseKit.framework/IMBaseKit.bundle
    //IMBaseKitPath(@"JKBank.plist")
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"Frameworks/IMBaseKit.framework/IMBaseKit.bundle/JKBank.plist" ofType:nil];
